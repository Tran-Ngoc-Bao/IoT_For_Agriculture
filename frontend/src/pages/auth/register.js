              ...
              <Stack spacing={1} sx={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <FormControlLabel
                  control={<Checkbox
                    name="checkboxes"
                    value="Bách Khoa"
                    checked={formik.values.checkboxes.includes("Bách Khoa")}
                    onChange={formik.handleChange}
                  />}
                  label="Bách Khoa"
                />
                <FormControlLabel
                  control={<Checkbox
                    name="checkboxes"
                    value="Hà Tây"
                    checked={formik.values.checkboxes.includes("Hà Tây")}
                    onChange={formik.handleChange}
                  />}
                  label="Hà Tây"
                />
                <FormControlLabel
                  control={<Checkbox
                    name="checkboxes"
                    value="Hà Đông"
                    checked={formik.values.checkboxes.includes("Hà Đông")}
                    onChange={formik.handleChange}
                  />}
                  label="Hà Đông"
                />
                <FormControlLabel
                  control={<Checkbox
                    name="checkboxes"
                    value="Vĩnh Phúc"
                    checked={formik.values.checkboxes.includes("Vĩnh Phúc")}
                    onChange={formik.handleChange}
                  />}
                  label="Vĩnh Phúc"
                />
